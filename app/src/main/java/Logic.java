 ...
 */
public class Logic extends Account {

  /** This is the method that will ultimately get called */
  public static void main(String[] args) {
    Account acct1 = new Account("raza");
    Account acct2 = new Account("HAIDER");
    /*
    ...
    */
    ...
    Account acctX = new Account("Bob", 27.50);
    ...
    acct2.makeCopyOf(acctX); // i am using existing one.
    ...
    */
    ...
    Account acctA = new Account("Sue Vlaki");
    Account acctB = new Account("Joseph schmoe", 187.13);
